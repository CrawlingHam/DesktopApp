(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/app_fb753e._.js", {
...
;
;
async function processVideoAddition(buttonType, setCurrentVideo, videos, addVideo, user, clearQueue, togglePlaylist, duration, soundCloudVideo, youtubeVideo, tiktokVideo, clearPlaylist) {
    ...
    if (user) {
        clearQueue();
        togglePlaylist(true);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$firebase$2f$addVideoToPlaylist$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__addVideoToPlaylist$3e$__["addVideoToPlaylist"])(user.uid, video);
        if (result.error) {
            if (result.error === "Video already exists in the playlist") {
...
function Playlist() {
    ...
    const { removeFromPlaylist, playlistID, playlistTitle, playlistVideos, setPlaylistVideos, setCurrentVideo, currentVideo, playNextVideo, playSelectedVideo } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$useMedia$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMedia"])();
    const videoPlaying = currentVideo || youtubeVideo || tiktokVideo || soundCloudVideo;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Playlist.useEffect": ()=>{
            if (videoPlaying) {
                const { video } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$VideoPlayer$2f$containsVideo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["containsVideoID"])(playlistVideos, videoPlaying.videoID);
            ...
            if (user) {
                const fetchPlaylist = {
                    "Playlist.useEffect.fetchPlaylist": async ()=>{
                        ...
                        setPlaylistVideos(uniqueVideos); // Set the unique playlist videos
    ...
    const handleRemoveVideo = async (videoIndex)=>{
        if (!user) return;
        const videoToRemove = playlistVideos[videoIndex];
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                className: "space-y-2",
                children: playlistVideos && Array.isArray(playlistVideos) && playlistVideos.map((video, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
...
_s(Playlist, "svmcT7VD+KEamgGOMhp5b4DQoBc=", false, function() {
    return [
...
const QueueButton = ()=>{
    ...
    const { addToQueue, videos, addVideo, setCurrentVideo, clearQueue, togglePlaylist, clearPlaylist } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$useMedia$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMedia"])();
    const onClickEvent = async (e)=>{
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$VideoPlayer$2f$processVideoAddition$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__processVideoAddition$3e$__["processVideoAddition"])("queue", setCurrentVideo, videos, addVideo, user, clearQueue, togglePlaylist, duration, soundCloudVideo, youtubeVideo, tiktokVideo, clearPlaylist);
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(StyledWrapper, {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            className: "btn",
...
_s(QueueButton, "14NsfCbGToxfX2xHU8ob/Cx7wGI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$useUser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$usePlayer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePlayer"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$useMedia$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMedia"]
...
const PlaylistButton = ()=>{
    _s();
    const { tiktokVideo, soundCloudVideo, youtubeVideo, duration } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$usePlayer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePlayer"])();
    const { addToPlaylist, videos, addVideo, clearPlaylist, playlistID, playlistVideos, setCurrentVideo, togglePlaylist, clearQueue } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$useMedia$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMedia"])();
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$useUser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"])();
    ...
    const onClickEvent = async (e)=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$VideoPlayer$2f$processVideoAddition$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__processVideoAddition$3e$__["processVideoAddition"])("playlist", setCurrentVideo, videos, addVideo, user, clearQueue, togglePlaylist, duration, soundCloudVideo, tiktokVideo, youtubeVideo, clearPlaylist);
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(StyledWrapper, {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s(PlaylistButton, "MpYiB5birXwL4HkYI/NACT9Rue8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$usePlayer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePlayer"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$useMedia$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMedia"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$useUser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"],
...
//# sourceMappingURL=app_fb753e._.js.map
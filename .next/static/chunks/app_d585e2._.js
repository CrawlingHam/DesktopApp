(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/app_d585e2._.js", {
...
"[project]/app/utils/VideoPlayer/setNewVideo.ts [app-client] (ecmascript) <export default as setNewVideo>": ((__turbopack_context__) => {
"use strict";

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, t: require } = __turbopack_context__;
{
__turbopack_esm__({
    "setNewVideo": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$VideoPlayer$2f$setNewVideo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$VideoPlayer$2f$setNewVideo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/app/utils/VideoPlayer/setNewVideo.ts [app-client] (ecmascript)");
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$useMedia$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/app/store/useMedia.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$VideoPlayer$2f$setNewVideo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__setNewVideo$3e$__ = __turbopack_import__("[project]/app/utils/VideoPlayer/setNewVideo.ts [app-client] (ecmascript) <export default as setNewVideo>");
...
function Queue() {
    ...
    const onVideoClick = async (url)=>{
        if (!currentVideo || !url || url === currentVideo.url) return;
        try {
            new URL(url);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$VideoPlayer$2f$setNewVideo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__setNewVideo$3e$__["setNewVideo"])(url, duration, queueVideos, setCurrentVideo, setYoutubeVideo, setSliderValue);
        } catch (error) {
    ...
    const handleRemoveVideo = async (videoIndex)=>{
        const videoToRemove = queueVideos[videoIndex];
        console.log("Removing video:", videoToRemove);
        removeFromQueue(videoToRemove);
        setTooltipVisible(false);
    };
...
function Playlist() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Playlist.useEffect": ()=>{
            if (videoPlaying) {
                const { video, index } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$VideoPlayer$2f$containsVideo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["containsVideoID"])(playlistVideos, videoPlaying.videoID);
...
_s(Playlist, "xHeqqPx/MkrV6cxbgeN2NheDrww=", false, function() {
    return [
...
//# sourceMappingURL=app_d585e2._.js.map
(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/app_d85d42._.js", {
...
async function createVideo({ videoID, platform, setYoutubeVideo, setTiktokVideo, setSoundCloudVideo, optionals }) {
    switch(platform){
        ...
        case "soundcloud":
            ...
            const extraction = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$VideoPlayer$2f$fetchTrackURL$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(embedUrl);
            if (!extraction.success) return;
            const soundCloudResults = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$VideoPlayer$2f$fetchTrackDetails$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extraction.href);
            if (soundCloudResults.success) {
                ...
                const newSoundCloudVideo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$VideoPlayer$2f$createNewVideo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(requiredSoundCloudVideoDetails, optionals);
...
async function processVideoAddition(buttonType, setCurrentVideo, videos, addVideo, user, togglePlaylist, duration, soundCloudVideo, youtubeVideo, tiktokVideo, clearVideos, pressed, setPressed, setShowTooltips) {
    ...
    if (!video) return;
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$VideoPlayer$2f$containsVideo$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["containsVideo"])(videos, video)) {
        console.log(buttonType);
        buttonType === "playlist" ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Video is already in the playlist") : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Video is already in the queue");
        return;
    }
...
function YoutubePlayer({ youtubePlayerRef, youtubeVideo }) {
    _s();
    const { resetSlider, setYoutubeVideo, setSoundCloudVideo, setTiktokVideo, setSliderValue, setDuration, sliderValue } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$usePlayer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePlayer"])();
    ...
    const handleProgress = (progress)=>{
        ...
        if (progress.playedSeconds >= sliderValue[1] - tolerance && progress.playedSeconds <= sliderValue[1] + tolerance || progress.playedSeconds >= sliderValue[1]) {
            if (loopEnabled) {
                ...
                playNextVideo(setTiktokVideo, setYoutubeVideo, setSoundCloudVideo, setSliderValue, isPlaylistActive, playlistID, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$createSearchParams$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSearchParams"]);
            }
        }
    };
...
_s(YoutubePlayer, "/rI8cjm43qHAGD8mWKfoKxVgn3M=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$usePlayer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePlayer"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$useMedia$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMedia"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$useUser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"]
...
function TiktokPlayer({ tiktokVideo }) {
    ...
    const { setYoutubeVideo, setSoundCloudVideo, setTiktokVideo, setSliderValue } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$usePlayer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePlayer"])();
...
_s(TiktokPlayer, "ZpoAhuRo3S7zcCQ+L7XFX2jyL18=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$usePlayer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePlayer"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$useMedia$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMedia"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$useUser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"]
...
"[project]/app/components/VideoPlayer/SoundCloudPlayer.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$useUser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/app/store/useUser.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$createSearchParams$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/app/utils/createSearchParams.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$player$2f$soundcloud$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/react-player/soundcloud.js [app-client] (ecmascript)");
;
var _s = __turbopack_refresh__.signature();
;
;
...
function SoundCloudPlayer({ soundCloudPlayerRef, soundCloudVideo }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$player$2f$soundcloud$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                playing: true,
                controls: true,
                url: url,
                width: "900px",
                ...
                onDuration: handleDuration,
                onError: ()=>{
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Error loading SoundCloud track, please check the URL.");
                }
            }, void 0, false, {
...
_s(SoundCloudPlayer, "/rI8cjm43qHAGD8mWKfoKxVgn3M=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$usePlayer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePlayer"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$useMedia$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMedia"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$store$2f$useUser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"]
...
_c = SoundCloudPlayer;
var _c;
__turbopack_refresh__.register(_c, "SoundCloudPlayer");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=app_d85d42._.js.map